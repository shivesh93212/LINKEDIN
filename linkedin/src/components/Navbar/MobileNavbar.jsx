...
import {Home,Users,Bell,Search, BriefcaseBusiness, MessageSquareText, PlusSquare,} from "lucide-react"
...
export default function MobileNavbar(){
    ...
    return (
        <>
        <header className="w-full bg-[#1b1f23] text-white sticky top-0 z-50">
        ...
        <footer className="fixed bottom-0 left-0 w-full bg-[#1b1f23] text-white border-t border-gray-700 z-50">
