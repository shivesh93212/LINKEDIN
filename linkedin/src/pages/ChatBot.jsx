...
export default function ChatBot() {
  ...
  const isAtBottomRef = useRef(true); // 🔥 track scroll position
  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      {/* HEADER FIXED */}
      <div className="sticky top-0 z-10 flex items-center gap-3 bg-gray-700 text-white px-4 py-3 shadow">
        <button
          onClick={() => navigate(-1)}
